...
import { getPocketBase, resetPocketBase, clearServerUrl } from '@/lib/pocketbase'
...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  // Listen for authStore changes (e.g. login/logout from other tabs)
  useEffect(() => {
    if (!pb) return
  ...
  const value = useMemo(
    ...
    [user, pb, isLoading, logout, refresh]
  )
