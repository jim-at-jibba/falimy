    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your family's shopping, todo, and packing lists</p>
        </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{ backgroundColor: getTypeColor(list.type) + '20' }}
                      >
                        {getTypeIcon(list.type)}
                      </div>
                      <div>
                        <CardTitle className="text-lg">{list.name}</CardTitle>
                        <CardDescription className="capitalize">{list.type}</CardDescription>
                      </div>
                    </div>
